  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        <Image src="/images/gym-space.png" alt="Modern space" fill className="object-cover" priority />
        ...
        <div className="relative z-10 bg-white rounded-3xl p-12 max-w-2xl mx-8 shadow-2xl">
          ...
          <div className="flex mb-8">
            ...
            <button
              ...
              className={`px-8 py-4 rounded-full text-lg font-semibold ml-4 transition-all duration-300 ${
                activeTab === "mission"
                  ? "bg-black text-white"
                  : "bg-transparent text-gray-600 border border-gray-300 hover:border-gray-400"
              }`}
      ...
      <div className="relative min-h-screen flex items-center">
        <Image src="/images/concrete-space.png" alt="Architectural space" fill className="object-cover" />
        ...
        <div className="relative z-10 w-full">
          <div className="max-w-7xl mx-auto px-8 lg:px-16">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-12 space-y-12">
                <div className="mb-12">
                  <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Our Core Values</h2>
                  <p className="text-lg text-gray-600">
                    These fundamental principles guide everything we do and shape our commitment to creating inclusive
                    digital experiences.
                  </p>
                </div>
                ...
                {coreValues.map((value, index) => {
                  ...
                  return (
                    <div key={value.id} className="group">
                      ...
                      {/* Divider */}
                      {index < coreValues.length - 1 && <div className="w-full h-px bg-gray-200 mt-8"></div>}
                    </div>
                  )
                })}
              </div>
